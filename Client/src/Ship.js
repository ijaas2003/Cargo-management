...
const changeHandler = value => {
  ...
  const postData = ()=>{
    fetch("http://localhost:4000/ship",{
  method:"post",
  headers:{
    "Content-Type":"application/json"
  },
  ...
  .then(data => {
    ...
    return (
      <div className="Form" style={{backgroundImage:'url(cargo-ship.jpg)'}}>
          <div className="box1234">
            ...
            <div className="put">
             ...
             <Payment Name={formvalues.Name} NickName={formvalues.NickName} Email={formvalues.Email} Dates={formvalues.Dates} KG={formvalues.KG*150} Text={formvalues.Text} Service={'Ship'}/>
          </div>
      </div>
    )
  }
