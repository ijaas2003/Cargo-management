...
const changeHandler = value => {
 ...
 /* const Payments = (Service) => {
    ...
    alert(Service);
    fetch("http://localhost:4000/airways",{
      method:"post",
      headers:{
      ...
      <div className="Form" >
          <div className="box1234">
            ...
            <div className="put">
              ...
              <div className="put">
                <input type="text" name="Phone" className='form-control' value={formvalues.Phone} onChange={handleChange} placeholder="Enter your Phone Number"  required="Required" maxLength={10}/>
              </div>
              <div className="put">
             ...
             <input className='btn btn-primary' type="submit" onClick={() => postData()}/>
            
             <Payment Name={formvalues.Name} NickName={formvalues.NickName} Email={formvalues.Email} Dates={formvalues.Dates} KG={formvalues.KG*1000} Text={formvalues.Text} Service={'Airways'}/>
            </div>
        </div>
        </div>
    )
